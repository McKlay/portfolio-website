...
const Footer = () => {
  return (
    <footer className="w-full text-white py-12 px-4 sm:px-10 bg-transparent relative z-10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-evenly gap-12 text-sm md:text-base text-gray-300">
        {/* Community */}
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-gray-500 text-sm">
        © Clay Sarte 2025 Inc. All rights reserved.
      </div>
    </footer>
  );
};
